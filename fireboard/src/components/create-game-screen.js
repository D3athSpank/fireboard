    ...
    return (
      <View style={{ flex: 1, backgroundColor: "white" }}>
				{this.state.players && this.state.players.length > 0 && (
						<View style={{ flex: 1, backgroundColor: "white" }}>
							<PlayerSelector isPlayerOne={true} players={this.state.players} onPlayerSelected={this.onPlayerSelected.bind(this)} selectedPlayer={this.state.playerOne} />
							<PlayerSelector isPlayerOne={false} players={this.state.players} onPlayerSelected={this.onPlayerSelected.bind(this)} selectedPlayer={this.state.playerTwo} />
						</View>
					)
				}
