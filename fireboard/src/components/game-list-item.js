	...
	render() {
		...
		return (
			<View style={{flex: 1, flexDirection: 'row', padding: 5, backgroundColor: this.props.even ?  '#ddd' : '#fff'}}>
				...
				<Text style={textStyle}>{`${this.props.game.home.score && this.props.game.home.score.score || '0'} - ${this.props.game.visitor.score && this.props.game.visitor.score.score || '0'}`}</Text>
